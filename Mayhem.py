...
class Uzzii:
        ...
        while True:
            try:
                ...
                if r.status_code in t:
                    print(f"{Fore.CYAN}Created {Fore.BLUE}Community")
            ...
            try:
                 ...
                 t = [200, 201, 204]
                 if r.status_code in t:
                     print(f"{Fore.BLUE}Disabled {Fore.CYAN}Community")
                 elif r.status_code == 429:
                     b = r.json()
                     print(f"{Fore.BLUE}RateLimited, retrying {Fore.CYAN}in {b['retry_after']} seconds")
                     time.sleep(b['retry_after'])
    ...
    async def Audit_Hang(self):
        guild = input(f"{Fore.CYAN}Guild {Fore.BLUE}Id: ")
        for i in range(9):
